...
* @param data the word of dictionary to insert
*/
public void insert( AnyType x, String data )
{
   if( newNode == null )
       newNode = new BinaryNode<AnyType>( null );
   newNode.element = x;
   newNode.strData = data;
...
public void printTree(BinaryNode t)
{
   if (t != nullNode) {
 		printTree(t.left);
   	System.out.println(t.element + " " + t.strData);
 		printTree(t.right);
   }
}
...
//   t.printTree( );
   System.out.println( "Insterions for Splay Tree" );
...
//   }
   ...
   System.out.println("The average time of insertion is: " + totalTime/NUMS + "ns");
   System.out.println( "Tree after insterions:" );
   ...
   for( int i = 1; i < NUMS; i++)
   {
  	 t.contains(rnd.nextInt(NUMS) + 1);
//  	 if (!t.contains( i ))
//  		 System.out.println("key " + i + " not found" );
   }
   totalTime = System.nanoTime() - startTime;
   System.out.println("The average time of search is: " + totalTime/NUMS + "ns");
   ...
   totalTime = System.nanoTime() - startTime;
   System.out.println( "Tree after removals:" );
   System.out.println("The average time of removal is: " + totalTime/NUMS + "ns");

   
   System.out.println( "****Create the Random value tree..." );

   System.out.println( "Insterions" );

   startTime = System.nanoTime();
//   for( int i = 1; i < NUMS; i++)
//   {
//       t.insert(rnd.nextInt(NUMS) + 1);
//   }
   totalTime = System.nanoTime() - startTime;
   System.out.println("The average time of insertion is: " + totalTime/NUMS + "ns");
   System.out.println( "Tree after insterions:" );
